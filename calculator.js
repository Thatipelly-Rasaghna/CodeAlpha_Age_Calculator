const agecalculator=()=>{
    ...
    return birthDetails.year > currentYear || (birthDetails.year === currentYear && (birthDetails.month>currentMonth || (birthDetails.month === currentMonth && (birthDetails.date > currentDate))));
    };
